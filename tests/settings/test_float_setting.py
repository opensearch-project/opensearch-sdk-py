...
from opensearch_sdk_py.settings.float_setting import FloatSetting
...
class TestFloatSetting(unittest.TestCase):
    def test_float_setting(self) -> None:
        s = FloatSetting("answer.to.life", 24.0)
        settings = Settings()
        ...
        self.assertRaises(ValueError, FloatSetting, "key", 10.0, 0.0, 5.0)

    def test_parser(self) -> None:
        parser = FloatSetting.Parser(0.0, 100.0, "foo", Setting.Property.FILTERED)
    ...
    def test_parser_read_write(self) -> None:
        parser = FloatSetting.Parser(-100.0, 100.0, "foo", Setting.Property.DYNAMIC, Setting.Property.NODE_SCOPE)
        ...
        parser = FloatSetting.Parser(0.0, 0.0, "").read_from(input)
