...
class TestThreadContextStruct(unittest.TestCase):
    def test_thread_context_struct_write(self):
        ...
        self.assertIn(output.getvalue(), [b'\x01\x03foo\x03bar\x01\x03baz\x02\x03qux\x04quux', b'\x01\x03foo\x03bar\x01\x03baz\x02\x04quux\x03qux'])

    def test_thread_context_struct_read(self):
        tcs = ThreadContextStruct()
    ...
    def test_empty_thread_context_struct(self):
        tcs = ThreadContextStruct()
