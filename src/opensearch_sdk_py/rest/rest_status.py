...
class RestStatus(Enum):
    ...
    NON_AUTHORITATIVE_INFORMATION = auto()  # 203
    ...
    REQUEST_ENTITY_TOO_LARGE = auto()  # 413
    ...
    REQUESTED_RANGE_NOT_SATISFIED = auto()  # 416
    ...
    FAILED_DEPENDENCY = auto()  # 424

    # 429 Too Many Requests (RFC6585)
    TOO_MANY_REQUESTS = auto()  # 429
    ...
    # that server.
    HTTP_VERSION_NOT_SUPPORTED = auto()  # 505
