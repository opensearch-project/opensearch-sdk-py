...
class IntegerSetting(Setting):
    ...
    def __init__(self, key: str, default_value: int, min_value: int = MIN_VALUE, max_value: int = MAX_VALUE, *properties: SettingProperty) -> None:
        ...
        super().__init__(SettingType.INTEGER, key, lambda s: str(default_value), None, parser, None, properties)
